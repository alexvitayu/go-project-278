...
Curious what'vs next for RxJS? Follow along with [Issue 6367](https://github.com/ReactiveX/rxjs/issues/6367).
...
It'vs recommended to pull in the Observable creation methods you need directly from `'rxjs'` as shown below with `range`.
