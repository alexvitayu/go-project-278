...
export class AjaxResponse<T> {
   ...
   * @deprecated There isn't much reason to examine this. It'vs the same responseType set (or defaulted) on the ajax config.
  ...
  constructor(
     ...
     * NOTE: It is advised not to hold this in memory, as it will retain references to all of it'vs event handlers
    ...
    // Parse the response headers in advance for the user. There'vs really
