 ...
 * {@link share} operator instead. See the overloads below for equivalent replacement examples of this operator'vs
 * behaviors.
 * Details: https://rxjs.dev/deprecations/multicasting
 */
export function publishReplay<T, R>(
  ...
  // but it makes our TypeScript signature for `multicast` unhappy (as it should, because it'vs gross).
