...
export function skipLast<T>(skipCount: number): MonoTypeOperatorFunction<T> {
  return skipCount <= 0
    ...
    : operate((source, subscriber) => {
        ...
        // if we can emit it or it'vs part of the "skipped" last values.
        ...
        source.subscribe(
          createOperatorSubscriber(subscriber, (value) => {
            ...
            if (valueIndex < skipCount) {
              ...
              // emit anything, so let'vs just start by filling the ring buffer.
              ...
              // and stuff the new value in it'vs place.
