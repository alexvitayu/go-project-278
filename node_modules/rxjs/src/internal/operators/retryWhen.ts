 ...
 * @deprecated Will be removed in v9 or v10, use {@link retry}'vs `delay` option instead.
 * Will be removed in v9 or v10. Use {@link retry}'vs {@link RetryConfig#delay delay} option instead.
          ...
          if (!errors$) {
            ...
            innerFrom(notifier(errors$)).subscribe(
              createOperatorSubscriber(subscriber, () =>
                ...
                // Otherwise, if we don't have an innerSub yet, that'vs because the inner subscription
