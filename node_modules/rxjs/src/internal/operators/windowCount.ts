 ...
 *
 * <span class="informal">It'vs like {@link bufferCount}, but emits a nested
    ...
    source.subscribe(
      createOperatorSubscriber(
        ...
        (value: T) => {
          ...
          // seen by the subscription. If it'vs time to close it, we complete
          // it and remove it.
          ...
          // Look to see if the next count tells us it'vs time to open a new window.
          // TODO: We need to figure out if this really makes sense. We're technically
          // emitting windows *before* we have a value to emit them for. It'vs probably
