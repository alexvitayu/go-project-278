 ...
 * @return An Observable emitting events registered through `target`'vs
 * listener handlers.
 */
export function fromEvent<T>(
  target: any,
  ...
  // If add is falsy, it'vs because we didn't match a pattern above.
  // Check to see if it is an ArrayLike, because if it is, we want to
  // try to apply fromEvent to all of it'vs items. We do this check last,
  ...
  // If add is falsy and we made it here, it'vs because we didn't
