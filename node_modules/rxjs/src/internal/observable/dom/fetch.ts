 ...
 * the promise returned by `fetch` will resolve as soon as the response'vs headers are
 * received.
 *
...
export function fromFetch<T>(
  ...
  return new Observable<Response | T>((subscriber) => {
    ...
    // let'vs process it and chain our abort signals, if necessary.
    // If a signal is provided, just have it finalized. It'vs a cancellation token, basically.
