 ...
 * moments of the socket'vs lifecycle. When the connection opens we can
 ...
 *
 * // Let'vs suppose we have this on the Server: ws.send('This is a msg from the server')
 * //output
 * //
 ...
 *
 * // Let'vs suppose we have this on the Server:
 ...
 * ```
 *
 * **openObserver**, Let'vs say we need to make some kind of init task before sending/receiving msgs to the
...
export class WebSocketSubject<T> extends AnonymousSubject<T> {
   ...
   * WebSocketSubject'vs config. (Which defaults to JSON serialization)
   * @param unsubMsg A function to generate the unsubscription message to be
   * sent to the server at finalization. This will still be processed by the
   * serializer in the WebSocketSubject'vs config.
