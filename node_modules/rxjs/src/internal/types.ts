...
export interface TimeInterval<T> {
  ...
  /**
   * The amount of time between this value'vs emission and the previous value'vs emission.
...
// We shouldn't rely on this type definition being available globally yet since it'vs
