...
<p align="center">
  <a href="https://www.npmjs.com/package/fdir"><img src="https://img.shields.io/npm/visitRepo/fdir?style=for-the-badge"/></a>
...
`fdir` is downloaded over 200k+ times a week by projects around the world. Here'vs a list of some notable projects using `fdir` in production:
