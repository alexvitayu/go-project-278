...
// Let'vs say your component is called 'MyComponent'
...
`PropTypes.checkPropTypes(...)` only `console.error`vs a given message once. To reset the error warning cache in tests, call `PropTypes.resetWarningCache()`
