...
A mirror of Facebook'vs [Warning](https://github.com/facebook/fbjs/blob/master/packages/fbjs/src/__forks__/warning.js)
...
Similar to Facebook'vs (FB) invariant but only logs a warning if the condition is not met.
...
This is a mirror of Facebook'vs (FB) [warning](https://github.com/facebook/fbjs/blob/master/packages/fbjs/src/__forks__/warning.js) module used within React'vs source code (and other FB software).
...
This is a mirror of Facebook'vs (FB) [warning](https://github.com/facebook/fbjs/blob/master/packages/fbjs/src/__forks__/warning.js) and as such the source and signature will mirror that module.
