...
export interface Options extends Schema.Options {
  ...
  /**
   * Include references in the AST to each node'vs corresponding CST node.
   *
   * Default: `false`
   */
...
export class Document extends Collection {
  ...
  type: Type.DOCUMENT
  /**
   * Anchors associated with the document'vs nodes;
 ...
 * document'vs schema is required for YAML string output.
 *
 ...
 *   options. To use a specific document'vs schema, use `doc.schema.createNode`.
 */
