...
export namespace Schema {
  ...
  interface DefaultTag extends BaseTag {
     ...
     * an explicit tag. For most cases, it'vs unlikely that you'll actually want to
     ...
     * explicit tag and detected using a regular expression. For most cases, it'vs
