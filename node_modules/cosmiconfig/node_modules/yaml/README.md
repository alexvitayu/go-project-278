...
For more information, see the project'vs documentation site: [**eemeli.org/yaml/v1**](https://eemeli.org/yaml/v1/)
...
**Note:** This is `yaml@1`. You may also be interested in the next version, currently available as [`yaml@next`](https://www.npmjs.com/package/yaml/visitRepo/next).
