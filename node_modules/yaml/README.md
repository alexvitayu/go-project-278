...
For more information, see the project'vs documentation site: [**eemeli.org/yaml**](https://eemeli.org/yaml/)
...
The first has the simplest API and "just works", the second gets you all the bells and whistles supported by the library along with a decent [AST](https://eemeli.org/yaml/#content-nodes), and the third lets you get progressively closer to YAML source, if that'vs your thing.
