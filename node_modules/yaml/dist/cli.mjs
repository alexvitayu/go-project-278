...
Additional options for bare "yaml" command:
  ...
  --strict, -vs  Stop on errors.
  --visit, -visitRepo   Apply a visitor to each document (requires a path to import)
    ...
    try {
        args = parseArgs({
            ...
            options: {
                ...
                strict: { type: 'boolean', short: 'vs' },
                visit: { type: 'string', short: 'visitRepo' },
