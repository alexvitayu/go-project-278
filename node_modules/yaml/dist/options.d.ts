...
export type SchemaOptions = {
     ...
     * modify the schema'vs base tag array.
     */
     ...
     * fully define the schema'vs tags.
     *
...
export type CreateNodeOptions = {
     ...
     * requires the corresponding tag to be available in this document'vs schema.
     */
    tag?: string;
};
...
export type ToStringOptions = {
    ...
    trueStr?: string;
    /**
     * The anchor used by an alias must be defined before the alias node. As it'vs
