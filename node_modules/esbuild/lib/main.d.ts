 ...
 * the terminal. This allows you to reuse the built-in behavior of esbuild'vs
 ...
 * convenience to be able to match esbuild'vs pretty-printing exactly. If you want
...
export interface InitializeOptions {
   ...
   * "esbuild.wasm" file.
   *
   * You can use this as an alternative to "wasmURL" for environments where it'vs
...
// Call this function to terminate esbuild'vs child process. The child process
// is not terminated and re-created after each API call because it'vs more
...
// (e.g. node and deno). Declaring it here allows esbuild'vs API to be used in
// these scenarios.
//
// There'vs an open issue about getting this problem corrected (although these
