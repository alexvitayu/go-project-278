...
export interface ParseOptions {
     ...
     * is thrown it will return the cookie'vs original value. If you provide your own encode/decode
...
export interface StringifyOptions {
     ...
     * a value into a string suited for a cookie'vs value, and should mirror `decode` when parsing.
     *
