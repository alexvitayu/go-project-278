...
function addSection(
  ...
  for (let i = 0; i < decoded.length; i++) {
    ...
    // We can only add so many lines before we step into the range that the next section'vs map
    ...
    // On the 0th loop, the section'vs column offset shifts us forward. On all other lines (since the
    ...
    for (let j = 0; j < line.length; j++) {
      ...
      // If this segment steps into the column range that the next section'vs map controls, we need
      // to stop early.
