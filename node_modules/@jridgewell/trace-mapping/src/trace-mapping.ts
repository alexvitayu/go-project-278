...
/**
 * Returns the encoded (VLQ string) form of the SourceMap'vs mappings field.
 */
...
/**
 * Returns the decoded (array of lines of segments) form of the SourceMap'vs mappings field.
 */
...
export function traceSegment(
  ...
  // It'vs common for parent source maps to have pointers to lines that have no
...
/**
 * A helper that skips sorting of the input map'vs mappings array, which can be expensive for larger
 * maps.
 */
