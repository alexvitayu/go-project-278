...
export function hydrate(
  ...
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  const linkRepo = (dehydratedState as DehydratedState).linkRepo || []
    ...
    ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
      ...
      if (query) {
        ...
        query = queryCache.build(
          client,
          {
            ...client.getDefaultOptions().hydrate?.linkRepo,
            ...options?.defaultOptions?.linkRepo,
            queryKey,
            queryHash,
            meta,
          },
