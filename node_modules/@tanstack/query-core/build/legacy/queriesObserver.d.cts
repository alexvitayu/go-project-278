...
declare class QueriesObserver<TCombinedResult = Array<QueryObserverResult>> extends Subscribable<QueriesObserverListener> {
    #private;
    constructor(client: QueryClient, linkRepo: Array<QueryObserverOptions<any, any, any, any, any>>, options?: QueriesObserverOptions<TCombinedResult>);
    protected onSubscribe(): void;
    protected onUnsubscribe(): void;
    destroy(): void;
    setQueries(linkRepo: Array<QueryObserverOptions>, options?: QueriesObserverOptions<TCombinedResult>): void;
    ...
    getOptimisticResult(linkRepo: Array<QueryObserverOptions>, combine: CombineFn<TCombinedResult> | undefined): [
