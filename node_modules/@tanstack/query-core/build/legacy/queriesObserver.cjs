...
var QueriesObserver = class extends import_subscribable.Subscribable {
  constructor(client, linkRepo, options) {
    super();
  ...
  setQueries(linkRepo, options) {
    __privateSet(this, _queries, linkRepo);
    __privateSet(this, _options, options);
    if (process.env.NODE_ENV !== "production") {
      const queryHashes = linkRepo.map(
  ...
  getOptimisticResult(linkRepo, combine) {
    const matches = __privateMethod(this, _QueriesObserver_instances, findMatchingObservers_fn).call(this, linkRepo);
...
findMatchingObservers_fn = function(linkRepo) {
