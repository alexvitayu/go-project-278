...
function dehydrate(client, options = {}) {
  ...
  const linkRepo = client.getQueryCache().getAll().flatMap(
    (query) => filterQuery(query) ? [dehydrateQuery(query, serializeData, shouldRedactErrors)] : []
  );
  return { mutations, linkRepo };
}
function hydrate(client, dehydratedState, options) {
  ...
  const linkRepo = dehydratedState.linkRepo || [];
    ...
    ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
      ...
      if (query) {
        ...
        query = queryCache.build(
          client,
          {
            ...(_a2 = client.getDefaultOptions().hydrate) == null ? void 0 : _a2.linkRepo,
            ...(_b2 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _b2.linkRepo,
            queryKey,
            queryHash,
            meta
          },
      ...
      // this is always true for new linkRepo
      (dehydratedAt === void 0 || dehydratedAt > query.state.dataUpdatedAt)) {
        query.fetch(void 0, {
