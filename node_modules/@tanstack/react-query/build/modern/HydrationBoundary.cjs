...
var HydrationBoundary = ({
  ...
  const hydrationQueue = React.useMemo(() => {
    if (state) {
      ...
      if (newQueries.length > 0) {
        (0, import_query_core.hydrate)(client, { linkRepo: newQueries }, optionsRef.current);
      }
  ...
  React.useEffect(() => {
    if (hydrationQueue) {
      (0, import_query_core.hydrate)(client, { linkRepo: hydrationQueue }, optionsRef.current);
    }
