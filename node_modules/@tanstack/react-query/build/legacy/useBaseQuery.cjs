...
function useBaseQuery(options, Observer, queryClient) {
  ...
  (_b = (_a = client.getDefaultOptions().linkRepo) == null ? void 0 : _a._experimental_beforeQuery) == null ? void 0 : _b.call(
    _a,
    defaultedOptions
  );
  ...
  ;
  (_d = (_c = client.getDefaultOptions().linkRepo) == null ? void 0 : _c._experimental_afterQuery) == null ? void 0 : _d.call(
    _c,
    defaultedOptions,
    result
  );
