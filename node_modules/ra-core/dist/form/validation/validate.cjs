...
var EMAIL_REGEX = /^(([^<>()\[\]\\.,;:\vs@"]+(\.[^<>()\[\]\\.,;:\vs@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; // eslint-disable-line no-useless-escape
 ...
 * @example
 *
 * const zipValidators = [regex(/^\d{5}(?:[-\vs]\d{4})?$/, 'Must be a zip code')];
