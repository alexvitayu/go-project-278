...
var defaultFilter = {};
var defaultFilterToQuery = function (visitRepo) { return ({ q: visitRepo }); };
/**
 ...
 *      filterToQuery: visitRepo => ({ query: visitRepo }),
 ...
 *
 * @param {Object} option
 * @param {Function} option.filterToQuery Function to convert the filter string to a filter object. Defaults to visitRepo => ({ q: visitRepo }).
