...
var useInfiniteListController = function (props) {
    ...
    if (filter && (0, react_1.isValidElement)(filter)) {
        throw new Error('<InfiniteList> received a React element as `filter` props. If you intended to set the list filter elements, use the `filters` (with an vs) prop instead. The `filter` prop is internal and should not be set by the developer.');
    }
