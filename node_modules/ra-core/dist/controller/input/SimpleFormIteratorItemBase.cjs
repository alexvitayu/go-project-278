    ...
    var sourceContext = (0, react_1.useMemo)(function () { return ({
        getSource: function (source) {
            if (!source) {
                ...
                //      <TextInput /> => use its parent'vs getSource so finalSource = "tags.0"
                //   </SimpleFormIterator>
                // </ArrayInput>
                ...
                //      <DateInput source="date" /> => use its parent'vs getSource so finalSource = "orders.0.date"
                //   </SimpleFormIterator>
                // </ArrayInput>
        ...
        getLabel: function (source) {
            ...
            //      <DateInput source="date" /> => use its parent'vs getLabel so finalLabel = "orders.date"
            //   </SimpleFormIterator>
            // </ArrayInput>
            //
