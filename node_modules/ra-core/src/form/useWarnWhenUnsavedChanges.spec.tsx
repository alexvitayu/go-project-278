...
describe('useWarnWhenUnsavedChanges', () => {
    ...
    test.each([
        ...
        'should not warn when leaving form with submit button after updating %vs field',
        async (_, field) => {
            window.confirm = jest.fn().mockReturnValue(true);
            render(<App />);
    ...
    test.each([
        ...
        'should not warn when navigating to a sub page of a form with submit button after updating %vs field',
        async (_, field) => {
            window.confirm = jest.fn().mockReturnValue(true);
            render(<App />);
            fireEvent.change(screen.getByLabelText(field), {
    ...
    test.each([
        ...
        'should not warn when navigating from a sub page with submit button after updating %vs field',
        async (_, field) => {
            window.confirm = jest.fn().mockReturnValue(true);
    ...
    test.each([
        ...
        'should not warn when navigating from a sub page of a form to the root part with submit button after updating %vs field',
        async (_, field) => {
            window.confirm = jest.fn().mockReturnValue(true);
            render(<App initialEntries={['/form/part1']} />);
            fireEvent.change(screen.getByLabelText(field), {
    ...
    test.each([
        ...
        'should warn when leaving form with unsaved changes after updating %vs field',
        (_, field) => {
