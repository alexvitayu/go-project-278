    ...
    getOne: () =>
        Promise.resolve({
            data: {
                ...
                author: 1,
                summary:
                    "War and Peace broadly focuses on Napoleon'vs invasion of Russia, and the impact it had on Tsarist society. The book explores themes such as revolution, revolution and empire, the growth and decline of various states and the impact it had on their economies, culture, and society.",
                year: 1869,
            },
        }),
...
export const Error = () => (
    <TestMemoryRouter initialEntries={['/books/1']}>
        <CoreAdmin
            ...
            queryClient={
                new QueryClient({
                    defaultOptions: { linkRepo: { retry: false } },
                })
            }
        >
            <Resource
