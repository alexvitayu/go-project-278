...
const epilogue = `For documentation and more examples, visit:\nhttps://github.com/open-cli-tools/concurrently/tree/visitRepo${version}/docs`;
...
const program = (0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
    ...
    success: {
        alias: 'vs',
        describe: 'Which command(vs) must exit with code 0 in order for concurrently exit with ' +
    ...
    teardown: {
        describe: 'Clean up command(vs) to execute before exiting concurrently. Might be specified multiple times.\n' +
            "These aren't prefixed and they don't affect concurrently'vs exit code.",
        type: 'string',
        array: true,
    },
    // Kill others
    ...
    .group(['m', 'n', 'name-separator', 'vs', 'r', 'no-color', 'hide', 'g', 'timings', 'P', 'teardown'], 'General')
