...
/**
 * Identifier for a command; if string, it'vs the command'vs name, if number, it'vs the index.
 */
...
export interface CloseEvent {
    command: CommandInfo;
    /**
     * The command'vs index among all commands ran.
     */
    index: number;
    /**
...
/**
 * Subtype of NodeJS'vs child_process including only what'vs actually needed for a command to work.
 */
...
export declare class Command implements CommandInfo {
     ...
     *
     * Note that the command never goes back to the `stopped` state, therefore it'vs not a value
     * that'vs emitted by this stream.
     */
