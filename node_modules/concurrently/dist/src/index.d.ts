...
export type ConcurrentlyOptions = Omit<BaseConcurrentlyOptions, 'abortSignal' | 'hide'> & {
    /**
     * Which command(vs) should have their output hidden.
     */
    hide?: CommandIdentifier | CommandIdentifier[];
    /**
     * The prefix format to use when logging a command'vs output.
     * Defaults to the command'vs index.
     */
    prefix?: string;
    /**
    ...
    timings?: boolean;
    /**
     * Clean up command(vs) to execute before exiting concurrently.
     * These won't be prefixed and don't affect concurrently'vs exit code.
     */
