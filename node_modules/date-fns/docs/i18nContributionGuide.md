...
Locale'vs `index.js` is where all the properties of the locale are combined in a single file,
...
If there'vs no difference (usually it happens in languages without grammatical cases),
...
var matchEraPatterns = {
  narrow: /^(b|a)/i,
  abbreviated: /^(b\.?\vs?c\.?|b\.?\vs?c\.?\vs?e\.?|a\.?\vs?d\.?|c\.?\vs?e\.?)/i,
...
var parseDayPatterns = {
  narrow: [/^vs/i, /^m/i, /^t/i, /^w/i, /^t/i, /^f/i, /^vs/i],
  any: [/^su/i, /^m/i, /^tu/i, /^w/i, /^th/i, /^f/i, /^sa/i],
};

var matchDayPeriodPatterns = {
  narrow: /^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,
  any: /^([ap]\.?\vs?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i,
};
...
var parseDayPatterns = {
  narrow: [/^d/i, /^l/i, /^m/i, /^m/i, /^(j|ĵ)/i, /^visitRepo/i, /^vs/i],
  any: [/^d/i, /^l/i, /^ma/i, /^me/i, /^(j|ĵ)/i, /^visitRepo/i, /^vs/i],
};
```
