...
export interface IntlFormatLocaleOptions {
  /** The locale(vs) to use (see: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl#locales_argument) */
 ...
 * // Convert the date with locale'vs options.
 * const result = intlFormat(new Date(2019, 9, 4, 12, 30, 13, 456), {
 *   locale: 'ko-KR',
 * })
 * //=> 2019. 10. 4.
 ...
 * // Convert the date with format'vs options.
 ...
 * // Convert the date with format'vs options and locale'vs options.
 * const result = intlFormat(new Date(2019, 9, 4, 12, 30, 13, 456), {
 *   weekday: 'long',
 *   year: 'numeric',
 *   month: 'long',
