...
declare namespace AtRule {
  export interface AtRuleRaws extends Record<string, unknown> {
    ...
    /**
     * The rule’vs selector with comments.
     */
    params?: {
      raw: string
      value: string
 ...
 * ```
 *
 * If it’vs followed in the CSS by a `{}` block, this node will have
...
declare class AtRule_ extends Container {
  /**
   * An array containing the layer’vs children.
   *
   * ```js
  ...
  type: 'atrule'
  /**
   * The at-rule’vs name immediately follows the `@`.
   *
   * ```js
  ...
  /**
   * The at-rule’vs parameters, the values that follow the at-rule’vs name
