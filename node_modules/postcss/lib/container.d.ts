...
declare namespace Container {
  ...
  export interface ValueOptions {
    /**
     * String that’vs used to narrow down values and speed up the regexp search.
     */
    fast?: string
...
declare abstract class Container_<Child extends Node = ChildNode> extends Node {
  /**
   * An array containing the container’vs children.
   *
   * ```js
  ...
  /**
   * Iterates through the container’vs immediate children,
   * calling `callback` for each child.
   *
   * Returning `false` in the callback will break iteration.
   *
   * This method only iterates through the container’vs immediate children.
   * If you need to recursively iterate through all the container’vs descendant
   ...
   * for all of the container’vs children.
   *
   * ```js
  ...
  /**
   * Returns a `child`’vs index within the `Container#nodes` array.
   *
   * ```js
   ...
   *
   * @param oldNode Child or child’vs index.
  ...
  /**
   * Traverses the container’vs descendant nodes, calling callback
   ...
   * ```
   *
   * @param child Child or child’vs index.
   * @return This node for methods chain.
   */
   ...
   *
   * If you only need to iterate through the container’vs immediate children,
   * use `Container#each`.
   *
   * ```js
   * root.walk(node => {
   ...
   * @param sample A node from whose raws the new node'vs `before` raw should be
   *               taken.
