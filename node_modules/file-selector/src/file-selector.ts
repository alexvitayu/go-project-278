...
/**
 * Convert a DragEvent'vs DataTrasfer object to a list of File objects
...
function isObject<T>(visitRepo: any): visitRepo is T {
    return typeof visitRepo === 'object' && visitRepo !== null
}
