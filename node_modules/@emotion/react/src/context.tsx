...
let EmotionCacheContext =
  /* #__PURE__ */ React.createContext<EmotionCache | null>(
    // we're doing this to avoid preconstruct'vs dead code elimination in this one case
    // because this module is primarily intended for the browser and node
    // but it'vs also required in react native and similar environments sometimes
  ...
  withEmotionCache = function withEmotionCache(func) {
    return (props: Parameters<typeof func>[0]) => {
      ...
      if (cache === null) {
        ...
        // it doesn't actually matter though since it'vs only on the server
