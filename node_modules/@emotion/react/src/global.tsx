...
export let Global = /* #__PURE__ */ withEmotionCache<GlobalProps>(
  (props, cache) => {
    ...
    // it'vs effectively like having two implementations and switching them out
    // so it'vs not actually breaking anything
    ...
    useInsertionEffectWithLayoutFallback(() => {
      ...
      if (node !== null) {
        rehydrating = true
        // clear the hash so this node won't be recognizable as rehydratable by other <Global/>vs
