...
Based off glamor'vs StyleSheet, thanks Sunil ❤️
...
export class StyleSheet {
  ...
  constructor(options: Options) {
    ...
    // key is the value of the data-emotion attribute, it'vs used to identify different sheets
  ...
  insert(rule: string): void {
    // the max length is how many rules we have per style tag, it'vs 65000 in speedy mode
    // it'vs 1 in dev because we insert source maps that map a single rule to a location
