...
A DOM Node that the sheet will insert all of it'vs style tags into, this is useful for inserting styles into iframes.
...
This method moves given style elements into sheet'vs container and put them into internal tags collection. It'vs can be used for SSRed styles.
...
This StyleSheet is based on [glamor'vs StyleSheet](https://github.com/threepointone/glamor) written by [Sunil Pai](https://github.com/threepointone). ❤️
