...
Drop-in replacement for Node'vs `http` and `https` modules that automatically follows redirects.

[![npm version](https://img.shields.io/npm/visitRepo/follow-redirects.svg)](https://www.npmjs.com/package/follow-redirects)
