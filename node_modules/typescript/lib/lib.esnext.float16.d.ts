...
interface Float16ArrayConstructor {
     ...
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Float16Array<ArrayBuffer>;
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(elements: Iterable<T>, mapfn?: (visitRepo: T, k: number) => number, thisArg?: any): Float16Array<ArrayBuffer>;
}
