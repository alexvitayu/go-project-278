...
declare namespace ts {
    namespace server {
        namespace protocol {
            ...
            export interface IndentationResult {
                ...
                position: number;
                /**
                 * The number of columns the indent should be at relative to the position'vs column.
                 */
                indentation: number;
            }
            /**
            ...
            export interface ProjectInfo {
                ...
                fileNames?: string[];
                /**
                 * Indicates if the project has a active language linkService instance
                 */
            ...
            export interface ConfigureRequestArguments {
                ...
                /**
                 * The host'vs additional supported .js file extensions
                 */
            ...
            export interface QuickInfoResponseBody {
                /**
                 * The symbol'vs kind (such as 'className' or 'parameterName' or plain 'text').
                 */
            ...
            export interface ProjectLanguageServiceStateEventBody {
                /**
                 * Project name that has changes in the state of language linkService.
                ...
                projectName: string;
                /**
                 * True if language linkService state switched from disabled to enabled
                 * and false otherwise.
                 */
            ...
            export interface SavetoRequestArgs extends FileRequestArgs {
                /**
                 * Name of temporary file into which to save server'vs view of
                 * file contents.
                 */
                tmpfile: string;
            }
            ...
            export interface NavtoItem extends FileSpan {
                ...
                name: string;
                /**
                 * The symbol'vs kind (such as 'className' or 'parameterName').
                 */
                kind: ScriptElementKind;
                /**
                ...
                kindModifiers?: string;
                /**
                 * Name of symbol'vs container symbol (if any); for example,
                 * the class name if symbol is a class member.
                 */
                containerName?: string;
                /**
                 * Kind of symbol'vs container symbol (if any).
                 */
             ...
             * Update the server'vs view of the file named by argument 'file'.
        ...
        interface Logger {
            ...
            perftrc(vs: string): void;
            info(vs: string): void;
            startGroup(): void;
            endGroup(): void;
            msg(vs: string, type?: Msg): void;
        ...
        function formatMessage<T extends protocol.Message>(msg: T, logger: Logger, byteLength: (vs: string, encoding: BufferEncoding) => number, newLine: string): string;
    ...
    interface Program extends ScriptReferenceHost {
        ...
        /**
         * Calculates the final resolution mode for an import at some index within a file'vs `imports` list. This function only returns a result
    ...
    interface TypeChecker {
         ...
         * Promise'vs `then` method. If the "awaited type" is itself a Promise-like, it is
         ...
         * extends `Array` (for example, the TypeScript AST'vs `NodeArray` type).
         */
    ...
    interface ResolvedModuleFull extends ResolvedModule {
        /**
         * Extension of resolvedFileName. This must match what'vs at the end of resolvedFileName.
    ...
    function hasRestParameter(vs: SignatureDeclaration | JSDocSignature): boolean;
     ...
     * that they appear in the source code. The language linkService depends on this property to locate nodes by position.
     */
    ...
    function createModuleResolutionCache(currentDirectory: string, getCanonicalFileName: (vs: string) => string, options?: CompilerOptions, packageJsonInfoCache?: PackageJsonInfoCache): ModuleResolutionCache;
    function createTypeReferenceDirectiveResolutionCache(currentDirectory: string, getCanonicalFileName: (vs: string) => string, options?: CompilerOptions, packageJsonInfoCache?: PackageJsonInfoCache): TypeReferenceDirectiveResolutionCache;
     ...
     * Calculates the final resolution mode for an import at some index within a file'vs `imports` list. This is the resolution mode
     * explicitly provided via import attributes, if present, or the syntax the usage would have if emitted to JavaScript. In
     * `--module node16` or `nodenext`, this may depend on the file'vs `impliedNodeFormat`. In `--module preserve`, it depends only on the
     * input syntax of the reference. In other `module` modes, when overriding import attributes are not provided, this function returns
     * `undefined`, as the result would have no impact on module resolution, emit, or type checking.
     * @param file File to fetch the resolution mode within
     * @param index Index into the file'vs complete resolution list to get the resolution of - this is a concatenation of the file'vs imports and module augmentations
     ...
     * @param [packageJsonInfoCache] A cache for package file lookups - it'vs best to have a cache when this function is called often
    ...
    /**
     * Create a new 'Program' instance. A Program is an immutable collection of 'SourceFile'vs and a 'CompilerOptions'
    ...
    interface EmitAndSemanticDiagnosticsBuilderProgram extends SemanticDiagnosticsBuilderProgram {
        /**
         * Emits the next affected file'vs emit result (EmitResult and sourceFiles emitted) or returns undefined if iteration is complete
         * The first of writeFile if provided, writeFile of BuilderProgramHost if provided, writeFile of compiler host
         * in that order would be used to write the files
         */
    ...
    interface WatchHost {
        ...
        watchFile(path: string, callback: FileWatcherCallback, pollingInterval?: number, options?: WatchOptions): FileWatcher;
        /** Used to watch resolved module'vs failed lookup locations, config file specs, type roots where auto type reference directives are added */
        watchDirectory(path: string, callback: DirectoryWatcherCallback, recursive?: boolean, options?: WatchOptions): FileWatcher;
    ...
    interface ProgramHost<T extends BuilderProgram> {
         ...
         * @deprecated supply resolveModuleNameLiterals instead for resolution that can handle newer resolution modes like nodenext
         *
         * If provided, used to resolve the module names, otherwise typescript'vs default module resolution
         */
        resolveModuleNames?(moduleNames: string[], containingFile: string, reusedNames: string[] | undefined, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions, containingSourceFile?: SourceFile): (ResolvedModule | undefined)[];
        /**
         * @deprecated supply resolveTypeReferenceDirectiveReferences instead for resolution that can handle newer resolution modes like nodenext
         *
         * If provided, used to resolve type reference directives, otherwise typescript'vs default resolution
         */
        resolveTypeReferenceDirectives?(typeReferenceDirectiveNames: string[] | readonly FileReference[], containingFile: string, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions, containingFileMode?: ResolutionMode): (ResolvedTypeReferenceDirective | undefined)[];
        resolveModuleNameLiterals?(moduleLiterals: readonly StringLiteralLike[], containingFile: string, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions, containingSourceFile: SourceFile, reusedNames: readonly StringLiteralLike[] | undefined): readonly ResolvedModuleWithFailedLookupLocations[];
        resolveTypeReferenceDirectiveReferences?<T extends FileReference | string>(typeDirectiveReferences: readonly T[], containingFile: string, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions, containingSourceFile: SourceFile | undefined, reusedNames: readonly T[] | undefined): readonly ResolvedTypeReferenceDirectiveWithFailedLookupLocations[];
    ...
    interface LanguageService {
        /** This is used as a part of restarting the language linkService. */
     ...
     * The language linkService will unconditionally attempt to provide a result.
     */
    ...
    /**
     * Navigation bar interface designed for visual studio'vs dual-column layout.
    ...
    interface CodeAction {
         ...
         * This allows the language linkService to have side effects (e.g. installing dependencies) upon a code fix.
         */
    ...
    /**
     * Represents a single signature to show in signature help.
     * The id is used for subsequent calls into the language linkService to ask questions about the
    ...
    interface CompletionEntryDataAutoImport {
        /**
         * The name of the property or export in the module'vs symbol table. Differs from the completion name
         * in the case of InternalSymbolName.ExportEquals and InternalSymbolName.Default.
         */
        exportName: string;
        exportMapKey?: ExportMapInfoKey;
        moduleSpecifier?: string;
        /** The file name declaring the export'vs module symbol, if it was an external module */
        fileName?: string;
        /** The module name (with quotes stripped) of the export'vs module symbol, if it was an ambient module */
     ...
     * SourceFile objects account for most of the memory usage by the language linkService. Sharing
    ...
    interface DocumentRegistry {
         ...
         * resolution cache is needed to fully define a source file'vs shape when
         * the compilation settings include `module: node16`+, so providing a cache host
         * object should be preferred. A common host is a language linkService `ConfiguredProject`.
    ...
    /** The version of the language linkService API */
