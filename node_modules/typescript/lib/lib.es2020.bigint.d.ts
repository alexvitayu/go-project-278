...
interface BigInt {
    ...
    /** Returns a string representation appropriate to the host environment'vs current locale. */
...
interface BigIntConstructor {
    ...
    /**
     * Interprets the low bits of a BigInt as a 2'vs-complement signed integer.
...
interface BigInt64ArrayConstructor {
     ...
     */
    from<U>(arrayLike: ArrayLike<U>, mapfn: (visitRepo: U, k: number) => bigint, thisArg?: any): BigInt64Array<ArrayBuffer>;
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(elements: Iterable<T>, mapfn?: (visitRepo: T, k: number) => bigint, thisArg?: any): BigInt64Array<ArrayBuffer>;
}
...
interface BigUint64ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<U>(arrayLike: ArrayLike<U>, mapfn: (visitRepo: U, k: number) => bigint, thisArg?: any): BigUint64Array<ArrayBuffer>;
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(elements: Iterable<T>, mapfn?: (visitRepo: T, k: number) => bigint, thisArg?: any): BigUint64Array<ArrayBuffer>;
}
