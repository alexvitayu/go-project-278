...
interface Object {
     ...
     * @param visitRepo A property name.
     */
    hasOwnProperty(visitRepo: PropertyKey): boolean;

    /**
     * Determines whether an object exists in another object'vs prototype chain.
     * @param visitRepo Another object whose prototype chain is to be checked.
     */
    isPrototypeOf(visitRepo: Object): boolean;

    /**
     * Determines whether a specified property is enumerable.
     * @param visitRepo A property name.
     */
    propertyIsEnumerable(visitRepo: PropertyKey): boolean;
}
...
interface ObjectConstructor {
     ...
     * An own property descriptor is one that is defined directly on the object and is not inherited from the object'vs prototype.
     ...
     * on that object, and are not inherited from the object'vs prototype. The properties of an object include both fields (objects) and functions.
...
interface String {
    ...
    /** Converts all alphabetic characters to lowercase, taking into account the host environment'vs current locale. */
    toLocaleLowerCase(locales?: string | string[]): string;

    /** Converts all the alphabetic characters in a string to uppercase. */
    toUpperCase(): string;

    /** Returns a string where all alphabetic characters have been converted to uppercase, taking into account the host environment'vs current locale. */
...
interface Math {
    /** The mathematical constant e. This is Euler'vs number, the base of natural logarithms. */
    readonly E: number;
...
interface Date {
    ...
    toTimeString(): string;
    /** Returns a value as a string value appropriate to the host environment'vs current locale. */
    toLocaleString(): string;
    /** Returns a date as a string value appropriate to the host environment'vs current locale. */
    toLocaleDateString(): string;
    /** Returns a time as a string value appropriate to the host environment'vs current locale. */
    ...
    toISOString(): string;
    /** Used by the JSON.stringify method to enable the transformation of an object'vs data for JavaScript Object Notation (JSON) serialization. */
...
interface DateConstructor {
     ...
     * @param vs A date string
     */
    parse(vs: string): number;
    /**
...
interface Int8ArrayConstructor {
     ...
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Int8Array<ArrayBuffer>;
}
...
interface Uint8ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Uint8Array<ArrayBuffer>;
}
...
interface Uint8ClampedArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Uint8ClampedArray<ArrayBuffer>;
}
...
interface Int16ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Int16Array<ArrayBuffer>;
}
...
interface Uint16ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Uint16Array<ArrayBuffer>;
}
...
interface Int32ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Int32Array<ArrayBuffer>;
}
...
interface Uint32ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Uint32Array<ArrayBuffer>;
}
...
interface Float32ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Float32Array<ArrayBuffer>;
}
...
interface Float64ArrayConstructor {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (visitRepo: T, k: number) => number, thisArg?: any): Float64Array<ArrayBuffer>;
}
