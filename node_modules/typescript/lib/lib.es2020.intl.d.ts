...
declare namespace Intl {
    ...
    interface RelativeTimeFormat {
         ...
         *
         * It is the caller'vs responsibility to handle cut-off logic
    ...
    const RelativeTimeFormat: {
         ...
         * without having to fall back to the runtime'vs default locale.
         *
         * @param locales - A string with a [BCP 47 language tag](http://tools.ietf.org/html/rfc5646), or an array of such strings.
         *  For the general form and interpretation of the locales argument,
         *  see the [`Intl` page](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl#Locale_identification_and_negotiation).
    ...
    interface LocaleOptions {
        ...
        baseName?: string;
        /** The part of the Locale that indicates the locale'vs calendar era. */
        calendar?: string;
        /** Flag that defines whether case is taken into account for the locale'vs collation rules. */
    ...
    interface Locale extends LocaleOptions {
        ...
        minimize(): Locale;
        /** Returns the locale'vs full locale identifier string. */
    ...
    interface DisplayNames {
         ...
         *    subsequence of the unicode_language_id grammar in [UTS 35'vs Unicode Language and Locale Identifiers grammar](https://unicode.org/reports/tr35/#Unicode_language_identifier).
    ...
    const DisplayNames: {
        ...
        /**
         * Returns an array containing those of the provided locales that are supported in display names without having to fall back to the runtime'vs default locale.
         *
         * @param locales A string with a BCP 47 language tag, or an array of such strings.
         *   For the general form and interpretation of the `locales` argument, see the [Intl](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl#locale_identification_and_negotiation)
         *   page.
         ...
         *
         * @returns An array of strings representing a subset of the given locale tags that are supported in display names without having to fall back to the runtime'vs default locale.
         *
