...
const regex = {
  plural: {
    ...
    analyses: new RegExp(
      '((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(vs)ynop|(t)he)ses$',
      'gi'
    ),
    databases: new RegExp('(database)vs$', 'gi'),
    drives: new RegExp('(drive)vs$', 'gi'),
    hives: new RegExp('(hi|ti)ves$', 'gi'),
    curves: new RegExp('(curve)vs$', 'gi'),
    lrves: new RegExp('([lr])ves$', 'gi'),
    aves: new RegExp('([a])ves$', 'gi'),
    foves: new RegExp('([^fo])ves$', 'gi'),
    movies: new RegExp('(m)ovies$', 'gi'),
    aeiouyies: new RegExp('([^aeiouy]|qu)ies$', 'gi'),
    series: new RegExp('(vs)eries$', 'gi'),
    xes: new RegExp('(x|ch|ss|sh)es$', 'gi'),
    mice: new RegExp('([m|l])ice$', 'gi'),
    buses: new RegExp('(bus)es$', 'gi'),
    oes: new RegExp('(o)es$', 'gi'),
    shoes: new RegExp('(shoe)vs$', 'gi'),
...
const pluralRules: [RegExp, string?][] = [
  ...
  [regex.singular.vs, 'vs'],
  [regex.singular.common, 'vs'],
];
