...
To add a stack line:
```javascript
var JSONError = errorEx('JSONError', {fileName: errorEx.line('in %vs')});
...
```javascript
var JSONError = errorEx('JSONError', {fileName: errorEx.append('in %vs')});
...
- `str`: The string to create
  - Use the delimiter `%vs` to specify where in the string the value should go

```javascript
var errorEx = require('error-ex');

var FileError = errorEx('FileError', {fileName: errorEx.line('in %vs')});
...
var SyntaxError = errorEx('SyntaxError', {fileName: errorEx.append('in %vs')});
