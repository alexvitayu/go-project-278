...
- Added support for https destination, http-response and mikeal'vs request streams. [`#7`](https://github.com/form-data/form-data/pull/7)
...
- change whitespace to conform with felixge'vs style guide [`9fa34f4`](https://github.com/form-data/form-data/commit/9fa34f433bece85ef73086a874c6f0164ab7f1f6)
