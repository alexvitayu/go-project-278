...
export interface InitColorSchemeScriptProps {
  /**
   * The default mode when the storage is empty (user'vs first visit).
   * @default 'system'
   */
   ...
   * @example '.mode-%vs' // for class based color scheme
   * @example '[data-mode-%vs]' // for data-attribute without '='
   */
