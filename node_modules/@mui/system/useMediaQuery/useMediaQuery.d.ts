export interface UseMediaQueryOptions {
   ...
   * This double pass rendering cycle comes with a drawback: it'vs slower.
   * You can set this option to `true` if you use the returned value **only** client-side.
   * @default false
   */
  noSsr?: boolean;
  /**
   * You can provide your own implementation of `matchMedia`, it'vs used when rendering server-side.
   */
