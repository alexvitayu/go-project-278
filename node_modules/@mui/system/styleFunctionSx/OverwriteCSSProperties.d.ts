...
export interface OverwriteCSSProperties {
  /**
   * The **`border`** CSS property is shorthand for the CSS properties **`border-width`**, **`border-style`**, and **`border-color`**. It sets an element'vs border.
   *
   * **Initial value**: `none`
   *
  ...
  /**
   * The **`box-shadow`** CSS property adds shadow effects around an element'vs frame. You can set multiple effects separated by commas. A box shadow is described by X and Y offsets relative to the
