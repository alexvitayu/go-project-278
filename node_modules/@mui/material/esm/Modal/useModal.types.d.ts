...
export interface UseModalReturnValue {
  ...
  /**
   * Resolver for the backdrop slot'vs props.
  ...
  /**
   * A ref to the component'vs root DOM element.
   */
  rootRef: React.RefCallback<Element> | null;
  /**
   * A ref to the component'vs portal DOM element.
   */
  ...
  exited: boolean;
  /**
   * If `true`, the component'vs child is transition component.
   */
