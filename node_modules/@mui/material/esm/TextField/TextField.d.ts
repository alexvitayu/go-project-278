...
export interface TextFieldSlots {
  ...
  /**
   * The component that renders the input'vs label.
   * @default InputLabel
   */
...
'onChange' | 'onBlur' | 'onFocus' | 'defaultValue'> {
   ...
   * The name can be confusing, as it'vs more like an autofill.
 ...
 *
 * It'vs important to understand that the text field is a simple abstraction
