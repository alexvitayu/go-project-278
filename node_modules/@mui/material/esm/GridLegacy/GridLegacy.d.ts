...
export interface RegularBreakpoints {
   ...
   * If 'auto', the grid item'vs width matches its content.
   * If false, the prop is ignored.
   * If true, the grid item'vs width grows to use the space available in the grid container.
...
export interface GridLegacyOwnProps extends SystemProps<Theme>, Breakpoints {
   ...
   * It'vs applied for all screen sizes.
   * @default 'wrap'
   */
  wrap?: GridLegacyWrap;
  /**
