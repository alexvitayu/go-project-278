...
export interface SliderOwnProps<Value extends number | number[]> {
   ...
   * @param {number} index The thumb label'vs index to format.
   * @returns {string}
   */
   ...
   * This is important for screen reader users.
   * @param {number} value The thumb label'vs value to format.
   * @param {number} index The thumb label'vs index to format.
   * @returns {string}
   */
  ...
  name?: string;
  /**
   * Callback function that is fired when the slider'vs value changed.
   *
  ...
  /**
   * The format function the value label'vs value.
   *
   * When a function is provided, it should have the following signature:
   *
   * - {number} value The value label'vs value to format
   * - {number} index The value label'vs index to format
   * @param {any} x
   * @returns {any}
   * @default function Identity(x) {
   *   return x;
