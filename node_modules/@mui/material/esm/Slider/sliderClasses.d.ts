export interface SliderClasses {
  ...
  thumb: string;
  /** State class applied to the thumb element if it'vs active. */
  active: string;
  ...
  valueLabel: string;
  /** Styles applied to the thumb label element if it'vs open. */
  valueLabelOpen: string;
  /** Styles applied to the thumb label'vs circle element. */
  valueLabelCircle: string;
  /** Styles applied to the thumb label'vs label element. */
