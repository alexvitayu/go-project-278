...
export interface UseSliderReturnValue {
  ...
  /**
   * Resolver for the hidden input slot'vs props.
  ...
  /**
   * Resolver for the thumb slot'vs props.
  ...
  /**
   * Resolver for the thumb slot'vs style prop.
  ...
  range: boolean;
  /**
   * Ref to the root slot'vs DOM node.
   */
