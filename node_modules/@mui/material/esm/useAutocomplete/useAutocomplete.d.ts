...
export interface UseAutocompleteProps<Value, Multiple extends boolean | undefined, DisableClearable extends boolean | undefined, FreeSolo extends boolean | undefined> {
  ...
  /**
   * If `true`, the input'vs text is cleared on blur if no value is selected.
   *
   ...
   * It'vs used to fill the input (and the list box options if `renderOption` is not provided).
   *
  ...
  readOnly?: boolean;
  /**
   * If `true`, the input'vs text is selected on focus.
...
export interface UseAutocompleteReturnValue<Value, Multiple extends boolean | undefined = false, DisableClearable extends boolean | undefined = false, FreeSolo extends boolean | undefined = false, HasGroupBy extends boolean = false> {
  ...
  /**
   * Resolver for the input label element'vs props.
  ...
  /**
   * Resolver for the `clear` button element'vs props.
  ...
  /**
   * Resolver for the popup icon'vs props.
  ...
  /**
   * Resolver for the listbox component'vs props.
   * @returns props that should be spread on the listbox component
   */
  getListboxProps: () => React.HTMLAttributes<HTMLUListElement>;
  /**
   * Resolver for the rendered option element'vs props.
