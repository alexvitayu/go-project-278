 ...
 * @returns {[Slot, slotProps]} The slot'vs React component and the slot'vs props
 *
 * Note: the returned slot'vs props
...
/**
 * The slot'vs name. All Material UI components should have `root` slot.
 *
...
name: T, parameters: (T extends 'root' ? {
  ...
  /**
   * The slot'vs className
   */
  className: ClassValue | ClassValue[];
  /**
   * The slot'vs default styled-component
   */
  elementType: ElementType;
  /**
   * The component'vs ownerState
   */
   ...
   * e.g. Autocomplete'vs listbox uses Popper + StyledComponent
   */
