...
export interface SwipeableDrawerProps extends Omit<DrawerProps, 'onClose' | 'open' | 'slots' | 'slotProps'>, SwipeableDrawerSlotsAndSlotProps {
  /**
   * If set to true, the swipe event will open the drawer even if the user begins the swipe on one of the drawer'vs children.
   ...
   * @param {HTMLDivElement} paper The drawer'vs paper element
   *
   * @default false
   */
   ...
   * Good threshold is between 250 - 1000 px/vs
   * @default 450
   */
