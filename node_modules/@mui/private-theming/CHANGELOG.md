...
- [infra] Migrate away from airbnb'vs eslint config (#46794) @brijeshb42
...
- [Dialog] Fix Form dialog demo'vs actions button padding (#46506) @frontman-git
...
- [icons] Fix typo in material-icons.md (#45334) @a-vs-russo
...
All contributors of this release in alphabetical order: @a-vs-russo, @aarongarciah, @DiegoAndai, @Janpot, @mapache-salvaje, @perkrlsn, @sai6855, @siriwatknp, @ZeeshanTamboli
