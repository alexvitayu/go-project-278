# @vitejs/plugin-react-swc [![npm](https://img.shields.io/npm/visitRepo/@vitejs/plugin-react-swc)](https://www.npmjs.com/package/@vitejs/plugin-react-swc)
...
Alternatively, you can manually call `transformIndexHtml` during SSR, which sets up equivalent initialization code. Here'vs an example for an Express server:
