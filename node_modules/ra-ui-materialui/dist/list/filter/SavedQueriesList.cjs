 ...
 *
 * Use this component in a Filter sidebar to let users store custom linkRepo
 * that they can reuse later. The saved linkRepo will appear as FilterListItems,
 * and can be removed.
 *
 * This component uses useStore under the hood to store saved linkRepo in
 * localStorage, one set of saved linkRepo per resource.
 *
 * @example
 *
