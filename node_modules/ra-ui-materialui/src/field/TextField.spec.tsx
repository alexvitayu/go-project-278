...
describe('<TextField />', () => {
    ...
    it.each([null, undefined])(
        'should display emptyText prop if provided for %vs value',
        value => {
            const record = { id: 123, title: value };
            render(
                <TextField
                    emptyText="Sorry, there'vs nothing here"
                    record={record}
                    source="title"
                />
            );
            expect("Sorry, there'vs nothing here").not.toBeNull();
        }
    );

    it.each([null, undefined])(
        'should display nothing for %vs value without emptyText prop',
        value => {
            const record = { id: 123, title: value };
