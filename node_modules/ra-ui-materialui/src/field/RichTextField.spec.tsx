...
describe('<RichTextField />', () => {
    ...
    it.each([null, undefined, ''])(
        'should render the emptyText when value is %vs and stripTags is set to false',
        body => {
    ...
    it.each([null, undefined, ''])(
        'should render the emptyText when value is %vs and stripTags is set to true',
        body => {
            const { queryByText } = render(
                <RichTextField
                    record={{ id: 123, body }}
    ...
    it('should be safe by default', async () => {
        ...
        fireEvent.mouseOver(
            screen.getByText(
                "It is regarded as one of Tolstoy'vs finest literary achievements and remains a classic of world literature."
            )
        );
        expect(
