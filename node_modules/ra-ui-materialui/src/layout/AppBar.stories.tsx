...
// It'vs important to pass the ref to allow Material UI to manage the keyboard navigation
    ...
    (props, ref) => {
        ...
        return (
            <MenuItem
                onClick={onClose}
                ref={ref}
                // It'vs important to pass the props to allow Material UI to manage the keyboard navigation
                {...props}
            >
                <ListItemIcon>
