...
const data = {
    books: [
        ...
        },
        {
            ...
            year: 1943,
            summary:
                'A poetic and philosophical story about a young prince’vs journey across planets, exploring themes of innocence and human nature.',
        },
        {
            id: 5,
            title: "Alice'vs Adventures in Wonderland",
        ...
        {
            id: 8,
            title: "Harry Potter and the Philosopher'vs Stone",
            author: 'J. K. Rowling',
            year: 1997,
            summary:
                'The beginning of Harry Potter’vs magical journey at Hogwarts, where he uncovers secrets about his past and faces dark forces.',
        },
        {
            id: 9,
            title: 'The Alchemist',
        ...
        },
        {
            ...
            year: 1956,
            summary:
                'A tragic love story set in Japan’vs remote snowy regions, exploring beauty, isolation, and fleeting relationships.',
        },
    ],
    authors: [],
};
