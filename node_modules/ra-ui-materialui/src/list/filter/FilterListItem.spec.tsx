...
describe('<FilterListItem/>', () => {
    it("should display the item label when it'vs a string", () => {
        render(
    ...
    it("should display the item label when it'vs an element", () => {
        render(
            <ListContextProvider value={defaultListContext}>
                <FilterListItem
    ...
    it("should display the item icon if it'vs provided", () => {
        render(
            <ListContextProvider value={defaultListContext}>
                <FilterListItem
                    label="Foo"
