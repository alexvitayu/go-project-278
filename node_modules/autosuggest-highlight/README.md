...
[![npm Version](https://img.shields.io/npm/visitRepo/autosuggest-highlight.svg?style=flat-square)](https://npmjs.org/package/autosuggest-highlight)
...
// highlighting:     visitRepo
var matches = match('some sweet text', 'vs'); // [[0, 1]]
```
...
```js
// text indices:     012345678901234
// highlighting:     visitRepo    visitRepo
var matches = match('some sweet text', 'vs vs'); // [[0, 1], [5, 6]]
```
...
// text indices:     012345678901234
// highlighting:     visitRepo    visitRepo
var matches = match('some sweet text', 'vs', { findAllOccurrences: true }); // [[0, 1], [5, 6]]
```
