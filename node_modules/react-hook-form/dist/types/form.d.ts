 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/register) • [Demo](https://codesandbox.io/vs/react-hook-form-register-ts-ip2j3) • [Video](https://www.youtube.com/watch?visitRepo=JFIpCoajYkA)
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/setfocus) • [Demo](https://codesandbox.io/vs/setfocus-rolus)
 *
 ...
 *   setFocus("name");
 * }, [setFocus])
 * // shouldSelect allows to select input'vs content on focus
...
export type UseFormGetValues<TFieldValues extends FieldValues> = {
     ...
     *
     * @remarks
     * [API](https://react-hook-form.com/docs/useform/getvalues) • [Demo](https://codesandbox.io/vs/react-hook-form-v7-ts-getvalues-txsfg)
     *
     * @returns form values
     *
     * @example
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/getfieldstate) • [Demo](https://codesandbox.io/vs/getfieldstate-jvekk)
 *
 * @param name - the path name to the form field value.
 *
 ...
 *
 * // It'vs ok to combine with useFormState
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/subscribe) • [Demo](https://codesandbox.io/vs/subscribe)
 *
...
export type UseFormWatch<TFieldValues extends FieldValues> = {
     ...
     *
     * @remarks
     * [API](https://react-hook-form.com/docs/useform/watch) • [Demo](https://codesandbox.io/vs/react-hook-form-watch-v7-ts-8et1d) • [Video](https://www.youtube.com/watch?visitRepo=3qLd69WMqKk)
     *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/trigger) • [Demo](https://codesandbox.io/vs/react-hook-form-v7-ts-triggervalidation-forked-xs7hl) • [Video](https://www.youtube.com/watch?visitRepo=-bcyJCDjksE)
 *
 * @param name - provide empty argument will trigger the entire form validation, an array of field names will validate an array of fields, and a single field name will only trigger that field'vs validation.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/clearerrors) • [Demo](https://codesandbox.io/vs/react-hook-form-v7-ts-clearerrors-w3ymx)
 *
 * @param name - the path name to the form field value.
 *
 * @example
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/setvalue) • [Demo](https://codesandbox.io/vs/react-hook-form-v7-ts-setvalue-8z9hx) • [Video](https://www.youtube.com/watch?visitRepo=qpv51sCH3fI)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/seterror) • [Demo](https://codesandbox.io/vs/react-hook-form-v7-ts-seterror-nfxxu) • [Video](https://www.youtube.com/watch?visitRepo=raMqvE0YyIY)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/unregister) • [Demo](https://codesandbox.io/vs/react-hook-form-unregister-4k2ey) • [Video](https://www.youtube.com/watch?visitRepo=TM99g_NW5Gk&feature=emb_imp_woyt)
 *
 * @param name - the path name to the form field value.
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/handlesubmit) • [Demo](https://codesandbox.io/vs/react-hook-form-handlesubmit-ts-v7-lcrtu) • [Video](https://www.youtube.com/watch?visitRepo=KzcPKB9SOEk)
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/resetfield) • [Demo](https://codesandbox.io/vs/priceless-firefly-d0kuv) • [Video](https://www.youtube.com/watch?visitRepo=IdLFcNaEFEo)
 *
 * @param name - the path name to the form field value.
 * @param options - keep form state options
 *
 ...
 *
 * @remarks
 * [API](https://react-hook-form.com/docs/useform/reset) • [Demo](https://codesandbox.io/vs/react-hook-form-reset-v7-ts-pu901) • [Video](https://www.youtube.com/watch?visitRepo=qmCLBjyPwVk)
 *
