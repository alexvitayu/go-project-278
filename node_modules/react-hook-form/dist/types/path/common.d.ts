 ...
 * as a list of individual {@link Key}vs.
 */
 ...
 *                 individual {@link Key}vs
 * @typeParam PT - accumulator of the {@link Key}vs which have been split from
 ...
 * The individual {@link Key}vs may be empty strings.
 ...
 * @typeParam PT - remaining {@link Key}vs which needs to be joined
 * @typeParam PS - accumulator of the already joined {@link Key}vs
 */
...
/**
 * Type which converts all keys of an object to {@link Key}vs.
...
/**
 * Type to check whether a type'vs property matches the constraint type
 ...
 * If a union of {@link Key}vs is passed, all {@link Key}vs have to be present
 * in the type.
 ...
 * @typeParam VPT - accumulates the prefix of {@link Key}vs which have been
