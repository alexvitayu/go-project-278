...
export interface Options extends Config {
     ...
     * if there is one. The filename is optional, but not all of Swc'vs
     ...
     *  or if it'vs "plugins" and "presets" have even been installed, since the file
...
export interface Config {
    /**
     * Note: The type is string because it follows rust'vs regex syntax.
     */
    test?: string | string[];
    /**
     * Note: The type is string because it follows rust'vs regex syntax.
...
export interface TsParserConfig {
    ...
    decorators?: boolean;
    /**
     * @deprecated Always true because it'vs in ecmascript spec.
     */
    dynamicImport?: boolean;
}
...
export interface ReactConfig {
     ...
     * `<f:image />`
     *
     * Though the JSX spec allows this, it is disabled by default since React'vs
...
export interface BaseModuleConfig {
    ...
    strictMode?: boolean;
    /**
     * Changes Babel'vs compiled import statements to be lazily evaluated when their imported bindings are used for the first time.
     *
