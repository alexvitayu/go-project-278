 ...
 * Currently only chromium'vs trace event format is supported.
 ...
 * or api'vs parameters (`transform(..., {trace})`). This is due to current tracing subscriber
 ...
 * @ignore
 *
 * Returns current binary'vs metadata to determine which binary is actually loaded.
 *
 * This is undocumented interface, does not guarantee stability across `@swc/core`'vs semver
