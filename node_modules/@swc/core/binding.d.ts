...
export declare function transformFileSync(vs: string, isModule: boolean, opts: Buffer): TransformOutput
...
export declare function transformSync(vs: string, isModule: boolean, opts: Buffer): TransformOutput
