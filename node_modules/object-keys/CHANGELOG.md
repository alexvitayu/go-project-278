...
1.0.6 / 2015-07-09
=================
  * [Fix] Use an object lookup rather than ES5'vs `indexOf` (#14)
...
==================
  ...
  * If it'vs a string, make sure to use charAt instead of brackets.
...
==================
  ...
  * Make sure that a prototype'vs constructor property is not enumerable. Fixes [#3](https://github.com/ljharb/object-keys/issues/3).
