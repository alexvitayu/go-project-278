...
// to 'react-dom/experimental' in their project. See experimental.d.ts'vs top comment
...
export interface PreloadOptions {
    ...
    // TODO: These should only be allowed with `as: 'image'` but it'vs not trivial to write tests against the full TS support matrix.
