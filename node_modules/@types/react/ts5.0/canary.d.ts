...
declare module "." {
    ...
    export interface ViewTransitionProps {
        ...
        /**
         * Combined with {@link className} if this `<ViewTransition>` or its parent Component is mounted and there'vs no other with the same name being deleted.
        ...
        /**
         * Combined with {@link className} if this `<ViewTransition>` or its parent Component is unmounted and there'vs no other with the same name being deleted.
         * `"none"` is a special value that deactivates the view transition name under that condition.
         */
         ...
         *
         * A difference between this and the browser'vs built-in view-transition-name: auto is that switching the DOM nodes within the `<ViewTransition>` component preserves the same name so this example cross-fades between the DOM nodes instead of causing an exit and enter.
         * @default "auto"
         */
        name?: "auto" | (string & {}) | undefined;
        /**
         * The `<ViewTransition>` or its parent Component is mounted and there'vs no other `<ViewTransition>` with the same name being deleted.
         */
        onEnter?: (instance: ViewTransitionInstance, types: Array<string>) => void | (() => void);
        /**
         * The `<ViewTransition>` or its parent Component is unmounted and there'vs no other `<ViewTransition>` with the same name being deleted.
         */
