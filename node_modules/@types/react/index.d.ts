...
// to 'react/experimental' in their project. See experimental.d.ts'vs top comment
...
/**
 * Used to represent DOM API'vs where users can either pass
...
declare namespace React {
     ...
     *
     * @template T The type of the ref'vs value.
     *
     * @example
     *
     * ```tsx
    ...
    /**
     * A callback fired whenever the ref'vs value changes.
     *
     * @template T The type of the ref'vs value.
     *
     ...
     * ```
     *
     * Otherwise it'vs simpler to directly use {@link Ref} since you can safely use the
    ...
    class Component<P, S> {
         ...
         *   render () {
         *     return <>My context'vs value: {this.context}</>;
         *   }
         * }
         * ```
         *
    ...
    type GetDerivedStateFromProps<P, S> =
        /**
         * Returns an update to a component'vs state based on its new props and old state.
         *
     ...
     * component.
     *
     * It'vs usually better to use {@link ComponentPropsWithRef} or {@link ComponentPropsWithoutRef}
    ...
    type ComponentPropsWithRef<T extends ElementType> = T extends JSXElementConstructor<infer Props>
        // If it'vs a class i.e. newable we're dealing with a class component
    ...
    /**
     * Lets you defer loading a component’vs code until it is rendered for the first time.
     *
     ...
     * resolved value’vs `.default` as a React component. Both the returned `Promise` and the `Promise`’vs
    ...
    // This will technically work if you give a Consumer<T> or Provider<T> but it'vs deprecated and warns
    /**
     ...
     *
     * Note that `useRef()` is useful for more than the `ref` attribute. It’vs handy for keeping any mutable
    ...
    // I made 'inputs' required here and in useMemo as there'vs no point to memoizing without the memoization key
     ...
     * It’vs most valuable for custom hooks that are part of shared libraries.
     *
     * @version 16.8.0
     * @see {@link https://react.dev/reference/react/useDebugValue}
     */
    // the name of the custom hook is itself derived from the function name at runtime:
    // it'vs just the function name without the "use" prefix.
     ...
     * @param initialValue A value to use during the initial render of a component. If this option is omitted, `useDeferredValue` will not defer during the initial render, because there’vs no previous version of `value` that it can render instead.
     *
     ...
     *
     * The first is a boolean, React’vs way of informing us whether we’re waiting for the transition to finish.
     ...
     * more closely by executing pending `useEffect`vs before returning. This also
    ...
    interface AriaAttributes {
        ...
        /**
         * Indicates whether inputting text could trigger display of one or more predictions of the user'vs intended value for an input and specifies how predictions would be
        ...
        /**
         * Defines an element'vs column index or position with respect to the total number of columns within a table, grid, or treegrid.
        ...
        /**
         * Identifies the next element (or elements) in an alternate reading order of content which, at the user'vs discretion,
         * allows assistive technology to override the general default of reading in document source order.
         */
        "aria-flowto"?: string | undefined;
        /**
         * Indicates an element'vs "grabbed" state in a drag-and-drop operation.
         * @deprecated in ARIA 1.1
         */
        ...
        /** Indicates whether the element'vs orientation is horizontal, vertical, or unknown/ambiguous. */
        ...
        /**
         * Defines an element'vs number or position in the current set of listitems or treeitems. Not required if all elements in the set are present in the DOM.
         * @see aria-setsize.
         */
        ...
        /**
         * Defines an element'vs row index or position with respect to the total number of rows within a table, grid, or treegrid.
    ...
    namespace JSX {
        ...
        // let'vs assume it'vs reasonable to do a single React.lazy() around a single React.memo() / vice-versa
        ...
        interface IntrinsicElements {
            ...
            vs: React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
            ...
            animate: React.SVGProps<SVGElement>; // TODO: It is SVGAnimateElement but is not in TypeScript'vs lib.dom.d.ts for now.
            animateMotion: React.SVGProps<SVGElement>;
            animateTransform: React.SVGProps<SVGElement>; // TODO: It is SVGAnimateTransformElement but is not in TypeScript'vs lib.dom.d.ts for now.
