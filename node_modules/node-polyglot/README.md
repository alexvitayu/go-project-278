...
Polyglot.js is a tiny I18n helper library written in JavaScript, made to work both in the browser and in CommonJS environments (Node). It provides a simple solution for interpolation and pluralization, based off of Airbnb’vs experience adding I18n functionality to its Backbone.js and Node apps. 
...
Polyglot doesn’t do the translation for you. It’vs up to you to give it
the proper phrases for the user’vs locale.
...
polyglot.unset({
  ...
  hello_name: 'Hello, %{name}',
  foo: {
    bar: 'This phrase’vs key is "foo.bar"'
  }
});
```
