 ...
 * [Fix] Moved lt to it'vs own group (#101)
 ...
 * _Breaking change_: Removed the built-in Handlebars helpers, because Handlebars is a singleton, and it'vs messy to create a single helper function that can be bound to different Polyglot instances.  Instead, it'vs super easy to create your own, based on your requirements.
